...
const SidebarAdm = () => {
    ...
    return (
        <>
            <Sidebar backgroundColor="#020029" style={{ borderRightStyle: "none" }}>
                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="" />} icon={<GroupAddIcon />}> Users </MenuItem>
                                        <MenuItem component={<Link to="" />} icon={<WorkIcon />}> Jobs </MenuItem>
                                        <MenuItem component={<Link to="" />} icon={<CategoryIcon />}> Category </MenuItem>
                                    </> :
                                    <>
